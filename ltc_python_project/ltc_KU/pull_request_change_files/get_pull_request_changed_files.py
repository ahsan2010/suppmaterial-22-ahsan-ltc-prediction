...
def get_pull_req_changed_files():
    pull_request_folder = '/scratch/ahsan/Java_Exam_Work/Result/pull_request/'
    json_folder = '/scratch/ahsan/Java_Exam_Work/Result/pull_request_changed_files/'
    ...
    for project in project_list:
        ...
        with open(pull_request_file) as csv_file:
            ...
            for row in csv_reader:
                ...
                if os.path.isfile("{}pull_request_files_{}_{}.json".format(json_output_dir,proj_name, pr_number)):
                ...
                res = request("{}/files?state=all&per_page=100".format(pr_url))
                time.sleep(2)
                ...
                with open("{}pull_request_files_{}_{}.json".format(json_output_dir,proj_name,pr_number), "w") as f:
                    json.dump(i, f)
