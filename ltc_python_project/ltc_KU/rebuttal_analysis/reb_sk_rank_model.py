...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 15:07:47 2024
...
def analyze_sk_rank_ku_xin_combined(year_list, item_list):
    result_list = []
    for file_name in item_list:
        result_list = []
        print(file_name)
        for year in year_list:
            location = "{}sk_model_input_year_{}_{}.txt".format(sk_rank_input_dir, file_name, year)
            df = analyze_ltc_feature(location)
            df['year'] = year
            result_list.append(df)
        pd_final = pd.concat(result_list)
        pd_final.to_csv('{}sk_rank_result_{}.csv'.format(sk_rank_result_dir, file_name),index = False)


sk_rank_result_dir = "/home/local/SAIL/ahsan/BACKUP/ahsan_project_2022/XinProjectResult/March_15_2024/results/sk_rank/"
sk_rank_input_dir = '/home/local/SAIL/ahsan/BACKUP/ahsan_project_2022/XinProjectResult/March_15_2024/results/sk_rank_input/'


#item_list = ['rq1', 'rq2', 'rq3', 'rq4_f1', 'rq5_f1']

#item_list = ["sm_analysis"]
#item_list = ['rq5-f2']
#item_list = ['rq6-f2']
item_list = ['reb-rq1', 'reb-rq2']

def main():
    year_list = [1, 2, 3]
    analyze_sk_rank_ku_xin_combined(year_list , item_list)
