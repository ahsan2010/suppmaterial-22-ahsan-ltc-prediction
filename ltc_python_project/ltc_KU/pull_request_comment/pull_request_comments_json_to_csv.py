...
json_reviewer_folder = '/scratch/ahsan/Java_Exam_Work/Result/pull_request_comments/'
json_to_csv_folder = '/scratch/ahsan/Java_Exam_Work/Result/pull_request_comments/comments_csv_files/'
