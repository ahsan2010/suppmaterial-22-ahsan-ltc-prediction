...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 17:51:49 2024
...
def run_sk_analysis():
    ...
    output_dir = '/home/local/SAIL/ahsan/BACKUP/ahsan_project_2022/XinProjectResult/March_15_2024/feature-analysis/sk-result/'
    year_list = [1,2,3]
    for year_value in year_list:
        for file_name in [KU_ALL_AUTO, KU_ALL_XIN_ALL_AUTO, KU_CUR_XIN_AUTO]:
            location = "{}/{}_sk_input_year_{}.txt".format(sk_input_dir,file_name,year_value)
