...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 15:29:14 2024
...
def analyze_sk_rank(year_list, model_type_list):
    output_dir = '/home/local/SAIL/ahsan/BACKUP/ahsan_project_2022/XinProjectResult/Sep-2023/features/feature-importance-analysis/re-run-shap-values-march-7-2024/final-sk-rank/'
    result_list = []
    for year in year_list:
        print(year)
        for model_type in model_type_list:
            location = "{}{}_sk_input_year_{}.txt".format(sk_analysis_dir,model_type,year)
            df = analyze_ltc_feature(location)
            df['ltc'] = year
            df['model'] = model_type
            file_path = '{}sk_result_{}_{}.csv'.format(output_dir,model_type, year)
            df.to_csv(file_path, index = False)
           
sk_analysis_dir = "/home/local/SAIL/ahsan/BACKUP/ahsan_project_2022/XinProjectResult/Sep-2023/features/feature-importance-analysis/re-run-shap-values-march-7-2024/sk-rank-data/"
...
def main():
    year_list = [1, 2, 3]    
    model_list = [KU_ALL_AUTO,KU_ALL_XIN_ALL_AUTO]
    analyze_sk_rank(year_list , model_list)
