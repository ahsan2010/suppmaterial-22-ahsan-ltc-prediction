...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 13 17:33:31 2024
...
def bootstrap_model_run(year_value,target_name):
    ...
    ku_exp_feature = ku_features_count + ku_prev_exp_count_col + ku_comm_exp_count_col
    ku_proj_feature = ku_proj_dim_count_col + ku_other_proj_dim_count_col
    ku_current_proj_exp_feature = ku_features_count + ku_proj_dim_count_col  
    ku_prev_proj_exp_feature = ku_prev_exp_count_col + ku_comm_exp_count_col + ku_other_proj_dim_count_col
    
    all_ku_count_feature = ku_features_count + ku_proj_dim_count_col + ku_prev_exp_count_col + ku_comm_exp_count_col 
    ...
    ku_exp_feature = ku_features_count + ku_prev_exp_count_col + ku_comm_exp_count_col
    ku_proj_feature = ku_proj_dim_count_col + ku_other_proj_dim_count_col
    ku_current_proj_exp_feature = ku_features_count + ku_proj_dim_count_col + ku_comm_exp_count_col 
    ku_prev_proj_exp_feature = ku_prev_exp_count_col + ku_comm_exp_count_col + ku_other_proj_dim_count_col
    
   
    feature_list = [ku_exp_feature,
                    ku_proj_feature,
                    ku_current_proj_exp_feature,
                    ku_prev_proj_exp_feature
                    ]
    
    for i in range(len(model_list_new)):
        X = pd_full_merged [feature_list[i]]
        result_ku = out_of_bootstrap_running('Ahsan_Java_Commit', model_list_new[i], X, Y, 100, year_value = year_value, file_name = model_list_new[i])
        result_ku.to_csv('{}ltc_{}_{}_100.csv'.format(output_path, year_value, model_list_new[i]))
