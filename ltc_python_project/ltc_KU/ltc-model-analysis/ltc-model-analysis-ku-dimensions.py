...
KULTC_SUM = "kultc_sum_feat"
KULTC_SUM_XIN = "kultc_sum_xin_feat"
...
def bootstrap_model_run(year_value,target_name):
    ...
    for i in range(len(model_list)):
        ...
        result_ku = out_of_bootstrap_running('Ahsan_Java_Commit', model_list[i], X, Y, 100, year_value = year_value, file_name = model_list[i])
        result_ku.to_csv('{}ltc_{}_{}_100.csv'.format(output_path, year_value, model_list[i]))
...
def auto_spearman_test(year_value,target_name):
    ...
    model_list = [KU_DEV_EXP_AUTO, XIN_FEAT_AUTO, KU_ALL_XIN_ALL_AUTO]
