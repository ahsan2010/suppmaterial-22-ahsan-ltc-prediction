...
ROOT = "/home/local/SAIL/ahsan/LTC_Project/other-project-ku-profile/"
input_file = ROOT + "other-project-ku-profile.csv"
output_file = ROOT + "other-proj-ku-dim.csv"
...
def generate_ku_proj_profile():
    ...
    for i in range(len(ltc_file_list)):
        ...
        pd_ku_feature_full.to_csv("{}other-proj-ku-dim-ltc-{}.csv".format(ROOT, i + 1), index = False)
