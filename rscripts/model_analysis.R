...
classifier_list = c('RandomForest','LogisticRegression','LightGBM')
classifier_id = 1

wilcox_result = NULL
# Year 1 analysis
year_value = 1
data_ku_model_year_1 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,ku_model_suffix),header=TRUE,sep=",")
data_xin_model_year_1 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,xin_model_suffix),header=TRUE,sep=",")
data_combined_ku_xin_model_year_1 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,combined_ku_xin_model_suffix),header=TRUE,sep=",")

data_ku_model_year_1 = data_ku_model_year_1 %>% filter(classifier == classifier_list[classifier_id])
data_xin_model_year_1 = data_xin_model_year_1 %>% filter(classifier == classifier_list[classifier_id])
data_combined_ku_xin_model_year_1 = data_combined_ku_xin_model_year_1 %>% filter(classifier == classifier_list[classifier_id])
...
# Year 2 analysis
year_value = 2
data_ku_model_year_2 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,ku_model_suffix),header=TRUE,sep=",")
data_xin_model_year_2 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,xin_model_suffix),header=TRUE,sep=",")
data_combined_ku_xin_model_year_2 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,combined_ku_xin_model_suffix),header=TRUE,sep=",")

data_ku_model_year_2 = data_ku_model_year_2 %>% filter(classifier == classifier_list[classifier_id])
data_xin_model_year_2 = data_xin_model_year_2 %>% filter(classifier == classifier_list[classifier_id])
data_combined_ku_xin_model_year_2 = data_combined_ku_xin_model_year_2 %>% filter(classifier == classifier_list[classifier_id])
...
# Year 3 analysis
year_value = 3
data_ku_model_year_3 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,ku_model_suffix),header=TRUE,sep=",")
data_xin_model_year_3 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,xin_model_suffix),header=TRUE,sep=",")
data_combined_ku_xin_model_year_3 = read.csv(sprintf("%sltc_%d_%s_100.csv",file_path,year_value,combined_ku_xin_model_suffix),header=TRUE,sep=",")

data_ku_model_year_3 = data_ku_model_year_3 %>% filter(classifier == classifier_list[classifier_id])
data_xin_model_year_3 = data_xin_model_year_3 %>% filter(classifier == classifier_list[classifier_id])
data_combined_ku_xin_model_year_3 = data_combined_ku_xin_model_year_3 %>% filter(classifier == classifier_list[classifier_id])
